        ...
        <div class="x-body">
            ...
            <xblock>
                <@shiro.hasPermission name="menu:create">
                    <button class="layui-btn" onclick="menu_add('添加菜单','admin-add.html','600','500')"><i class="layui-icon">&#xe608;</i>添加</button>
                </@shiro.hasPermission>
                <@shiro.hasPermission name="menu:update">
                 <button class="layui-btn" onclick="menu_add('修改菜单','admin-add.html','600','500')"><i class="layui-icon">&#xe608;</i>修改</button>
                </@shiro.hasPermission>
            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-manage">
                            <@shiro.hasPermission name="menu:update">
                             <a title="编辑" href="javascript:;" onclick="menu_edit('编辑','admin-edit.html','4','','510')"class="ml-5" style="text-decoration:none">
                                 <i class="layui-icon">&#xe642;</i>
                             </a>
                            </@shiro.hasPermission>
                            <@shiro.hasPermission name="menu:delete">
                               <a title="删除" href="javascript:;" onclick="menu_del(this,'1')"style="text-decoration:none">
                                   <i class="layui-icon">&#xe640;</i>
                               </a>
                            </@shiro.hasPermission>
                        </td>
